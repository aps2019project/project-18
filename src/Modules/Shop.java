...
public class Shop {
    ...
    private void initializeCards() {
        ...
        cards.add(new Spell("Total Disarm", "Disarm one enemy force for hole game", 1000, 0, "enemy force"));
        cards.add(new Spell("Area Dispel", "Destroy all enemy force positive buff and all own force negative buff in 2*2 area", 1500, 2, "2*2"));
        cards.add(new Spell("Empower", "Add 2 AP to one own force", 250, 1, "own force"));
        cards.add(new Spell("Fireball", "Hit 4 HP to one enemy force", 400, 1, "enemy force"));
        cards.add(new Spell("God Strength", "Add 4 AP to own hero", 450, 2, "own hero"));
        cards.add(new Spell("HellFire", "For 2 turns make target point fire place", 600, 3, "2*2"));
        cards.add(new Spell("Lighting Bolt", "Hit 8 HP to enemy hero", 1250, 2, "enemy hero"));
        cards.add(new Spell("Poison Lake", "For 1 turn make target point poison place", 900, 5, "3*3"));
        cards.add(new Spell("Madness", "For 3 turns add 4 AP to one own force but disarm it", 650, 0, "own force"));
        cards.add(new Spell("All Disarm", "All enemy force disarm for 1 turn", 2000, 9, "all enemy force"));
        cards.add(new Spell("All poison", "All enemy force poison for 4 turns", 1500, 8, "all enemy force"));
        cards.add(new Spell("Dispel", "Destroy all positive buff one enemy force or all negative buff one own force", 2100, 0, "one force"));
        cards.add(new Spell("Health with profit", "Add one weakness buff with decrease 6 HP to one own force but give it 2 holy buff for 3 turns", 2250, 0, "own force"));
        cards.add(new Spell("Power Up", "Add one power buff with increase 6 AP to one own force", 2500, 2, "own force"));
        cards.add(new Spell("All power", "Add one power buff with increase 2 AP to all own force for hole game", 2000, 4, "all own force"));
        cards.add(new Spell("All Attack", "Hit 6 HP to all enemy forces in target column", 1500, 4, "all enemy hero in column"));
        cards.add(new Spell("Weakening", "Add one weakness buff with decrease 4 AP to one enemy minion", 1000, 1, "one enemy minion"));
        cards.add(new Spell("Sacrifice", "Add one weakness buff with decrease 6 HP and add one power buff with increase 8 AP to one own minion", 1600, 2, "one own monion"));
        cards.add(new Spell("Kings Guard", "Kill one random enemy minion in own hero side", 1750, 9, "dasti handle shavad"));
        cards.add(new Spell("Shock", "Stun one enemy force for 2 turn", 1200, 1, "one enemy hero"));
        cards.add(new Minion("Persian crossbowman", "", 300, 4, 6, "ranged", 7, 2));
        cards.add(new Minion("Persian swordsman", "On attack stun target for next turn", 400, 4, 6, "melee", 0, 2));
        cards.add(new Minion("Persian lancer", "", 500, 3, 5, "hybrid", 3, 1));
        cards.add(new Minion("Persian horseman", "", 200, 6, 10, "melee", 0, 4));
        cards.add(new Minion("Persian hero", "be tedad dafaAti ke dar nobat haye ghabl be yek niro hamle karde 5 vahed bishtar be an zarbe mizanad", 600, 6, 24, "melee", 0, 9));
        ...
        cards.add(new Minion("Torani spy", "Disarm target for 1 turn and poison it for 4 turns", 700, 6, 6, "melee", 0, 4));
        ...
        cards.add(new Minion("Eagle", "Have 10 power buf with increase 1 HP (Passive)", 200, 2, 0, "ranged", 3, 2));
        cards.add(new Minion("Demon ride swine", "", 300, 8, 16, "melee", 0, 6));
        cards.add(new Minion("Demon with one eye", "On death hit 2 HP to all minion in its side", 500, 11, 12, "hybrid", 3, 7));
        cards.add(new Minion("Poison snake", "Poison target for 3 turns", 300, 6, 5, "ranged", 4, 4));
        cards.add(new Minion("Dragon throw fire", "", 250, 5, 9, "ranged", 4, 5));
        cards.add(new Minion("Wild lion", "Target holy buff doesn't decrease Wild lion AP", 600, 8, 1, "melee", 0, 2));
        cards.add(new Minion("Big snake", "vaghti big snake spawn mishe minion haye dar khane haye ta 2 vahed fasele be tor daem hamishe 1 vahed bishtar zarbe mikhorand", 500, 7, 14, "ranged", 5, 8));
        cards.add(new Minion("White wolf", "When attack to minion next turn decrease 6 HP and next turn 4 HP", 400, 2, 8, "melee", 0, 5));
        cards.add(new Minion("Leopard", "When attack to minion next turn decrease 8 HP", 400, 2, 6, "melee", 0, 4));
        cards.add(new Minion("Wolf", "When attack to minion next turn decrease 6", 400, 1, 6, "melee", 0, 3));
        cards.add(new Minion("Witch", "For his self and all own minion from his sides add one power buff with increase 2 AP and one weakness buff with decrease 1 HP for 1 turn", 550, 4, 5, "ranged", 3, 4));
        cards.add(new Minion("Grand witch", "For his self and all own minion from his sides add one continuous power buff with increase 2 AP and one continuous holy buff", 550, 6, 6, "ranged", 5, 6));
        cards.add(new Minion("Jen", "Give all won minions one continuous power buff with increase 1 AP", 500, 4, 10, "ranged", 4, 5));
        cards.add(new Minion("Wild swine", "It won't become disarm", 500, 14, 10, "melee", 0, 6));
        cards.add(new Minion("Piran", "He won't become poison", 400, 20, 8, "melee", 0, 8));
        cards.add(new Minion("Giv", "Doesn't take any negativity", 450, 7, 5, "ranged", 5, 4));
        cards.add(new Minion("Bahman", "On respawn decrease 16 HP random enemy minion", 450, 9, 16, "melee", 0, 8));
        cards.add(new Minion("Ashkbos", "Force with lower AP can't hit him", 400, 8, 14, "melee", 0, 7));
        cards.add(new Minion("Iranj", "", 500, 20, 6, "ranged", 3, 4));
        cards.add(new Minion("Big ogre", "", 600, 8, 30, "hybrid", 2, 9));
        cards.add(new Minion("Ogre with two head", "When attack to force destroy all target positive buff", 550, 4, 10, "melee", 0, 4));
        cards.add(new Minion("Nane sarma", "On spawn Stun all enemy minion on her sides", 500, 4, 3, "ranged", 5, 3));
        cards.add(new Minion("Folaf zereh", "Have 12 continuous holy buff", 650, 1, 1, "melee", 3, 0));
        cards.add(new Minion("Siyavash", "On death hit 6 HP to enemy hero", 350, 5, 8, "melee", 0, 4));
